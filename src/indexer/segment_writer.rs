...
pub struct SegmentWriter {
    pub max_doc: DocId,
    pub ctx: IndexingContext,
    pub per_field_postings_writers: PerFieldPostingsWriter,
    pub segment_serializer: SegmentSerializer,
    pub fast_field_writers: FastFieldsWriter,
    pub fieldnorms_writer: FieldNormsWriter,
    pub json_path_writer: JsonPathWriter,
    pub json_positions_per_path: IndexingPositionsPerPath,
    pub doc_opstamps: Vec<Opstamp>,
